...
class SiparisModel extends BaseModel {
  ...
  @override
  String toString() =>
      'SiparislerModel(id: $id, cariId: $cariId, cariAdi: $cariAdi, cariIslemTuru: $cariIslemTuru, siparisStatus: $siparisStatus,kayitTarihi: $kayitTarihi, siparisTarihi :$siparisTarihi, personelId: $personelId, siparisKalemleri: $siparisKalemleri)';
